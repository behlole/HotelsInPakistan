            ...
            <div class="col-sm-6" style="border-left: 1px solid grey;">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="{{ URL('/hotel_listings') }}" style="background-color: #ff6c2d" class="btn btn-primary ">Go For Listing</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6" style="border-left: 1px solid grey;">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <a href="{{ URL('/add_new_restaurant') }}" style="background-color: #ff6c2d" class="btn btn-primary ">Go For Listing</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6" style="border-left: 1px solid grey;">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <a href="{{ URL('/home_listing') }}" style="background-color: #ff6c2d" class="btn btn-primary ">Go For Listing</a>
                </div>
              </div>
            </div>
            <div class="col-sm-6" style="border-left: 1px solid grey;">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
                  <a href="{{ URL('/new_agency_listing') }}" style="background-color: #ff6c2d" class="btn btn-primary ">Go For Listing</a>
                </div>
              </div>
            </div>
          </div>
