...
<form  action="{{ URL('update_hotel_info',$d->id) }}" method="post" id="upload">
  <input type="hidden" name="_token" value="{{ csrf_token() }}">
  <br><br>
 
  <div class="theme-payment-page-sections-item">
   <h3 class="theme-payment-page-sections-item-title">Update Hotel Basic Information</h3>
    ...
    <div class="row" data-gutter="20">
      ...
      <div class="col-md-12 ">
        <div class="form-group">
          ...
          <input id="password" type="text" class="form-control" data-error="#home_name_error" name="hotel_name" placeholder="Hotel Name" value="<?php 
