@foreach($hotel_pics as $pic)
<input type="hidden" id="hotel_pic_parent_id" value="{{$pic->hotel_pic_parent_id}}">
 <?php
 $dir_path = 'hotel_images/'.$pic->foldername;
           ...
           <div class="col-md-3 " >
              <div class="theme-item-page-facilities-item">
               ...
               <p class="theme-item-page-facilities-item-body">
                ...
                <p style="" id="{{$name}}" class="btn btn-danger  btn-xs clickme">Remove this Image</p>
                <p style="" id="{{$name}}" class="btn btn-primary  btn-xs clickme">Main Image</p>
              </p>
            </div>
          </div>
        <?php }
