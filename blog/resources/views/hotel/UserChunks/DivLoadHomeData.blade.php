    ...
    <div class="row" data-gutter="20">
      <div class="col-md-5 ">
        ...
        <div class="theme-search-results-item-img-wrap">
          <img style="height: 150px;" class="theme-search-results-item-img" src="<?php echo($varath);  ?>"  alt="Image Alternative text" title="Image Title"/>
        </div>
      </div>
      <div class="col-md-5">
...
<div class="_desk-h">
 @foreach($data as $d)
 <?php  $var = 'hotel_images/'.$d->foldername.'/'.$d->main_header;
 ?>
