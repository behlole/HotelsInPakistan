    ...
    <h5 style="font-size:16px; " class="theme-item-page-overview-rate-title">Welcome To Hotels In Pakistan</h5>
    <ul class="theme-sidebar-section-features-list">
      <li>
      <h5 class="theme-sidebar-section-features-list-title">Manage your Listing!</h5>
