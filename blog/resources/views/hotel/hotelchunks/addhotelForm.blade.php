<form  action="/add_hotel_listing" method="post" id="upload">
  <input type="hidden" name="_token" value="{{ csrf_token() }}">
  <br><br>
  <div class="theme-payment-page-sections-item">
   <h3 class="theme-payment-page-sections-item-title">Enter Hotel Basic Information</h3>
    ...
    <div class="row" data-gutter="20" id="errorTxt">
      ...
      <div class="col-md-12 ">
        <div class="form-group">
          ...
          <input id="password" type="text" class="form-control" name="hotel_name" placeholder="Hotel Name" value="{{old('hotel_name')}}" data-error="#home_name_error">
...
<div class="col-md-6">
  <div class="form-group">
   <label for="sel1">Hotel Email</label>
   <input id="password" data-error="#home_email" type="email"  class="form-control" name="email" placeholder="Please Enter Hotel Email" value="{{old('email')}}">
