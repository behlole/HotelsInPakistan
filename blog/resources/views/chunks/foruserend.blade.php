                        ...
                        <div class="theme-mobile-app-body">
                          ...
                          <ul class="theme-mobile-app-btn-list">
                            <li>
                              <a class="btn btn-dark theme-mobile-app-btn" href="#">
                                <i class="theme-mobile-app-logo">
                                  <img src="{{ URL::asset('img/brands/apple.png') }}" alt="Image Alternative text" title="Image Title"/>
                                </i>
                                <span>Coming Soon
                                  <br/>
                                  <span>App Store</span>
                            ...
                            <li>
                              <a class="btn btn-dark theme-mobile-app-btn" href="#">
                                <i class="theme-mobile-app-logo">
                                  <img src="{{ URL::asset('img/brands/play-market.png') }}" alt="Image Alternative text" title="Image Title"/>
                                </i>
                                <span>Coming Soon
                                  <br/>
