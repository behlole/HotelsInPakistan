...
"></a>
    ...
    <script src="{{ URL::asset('js/blur-area.js') }}"></script>
    ...
    <script src="{{ URL::asset('js/ion-range-slider.js') }}"></script>
    <script src="{{ URL::asset('js/sticky-kit.js') }}"></script>
    <script src="{{ URL::asset('js/smooth-scroll.js') }}"></script>
    <script src="{{ URL::asset('js/fotorama.js') }}"></script>
    <script src="{{ URL::asset('js/bs-datepicker.js') }}"></script>
    <script src="{{ URL::asset('js/typeahead.js') }}"></script>
    <script src="{{ URL::asset('js/quantity-selector.js') }}"></script>
    <script src="{{ URL::asset('js/countdown.js') }}"></script>
    <script src="{{ URL::asset('js/window-scroll-action.js') }}"></script>
    <script src="{{ URL::asset('js/fitvid.js') }}"></script>
    <script src="{{ URL::asset('js/youtube-bg.js') }}"></script>
