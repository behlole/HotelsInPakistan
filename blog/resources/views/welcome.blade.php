  ...
  <div class="theme-hero-area-body">
    <div class="_pt-250 _pb-200 _pv-mob-50">
          ...
          <div class="tabbable">
                ...
                <div class="theme-search-area theme-search-area-stacked">
                  <div class="theme-search-area-form">
                    <div class="row" data-gutter="none">
                     @include('hotel.UserChunks.hotelsearchform
                     ')
                   </div>
                 </div>
             ...
             <div class="tab-pane" id="SearchAreaTabs-2" role="tab-panel">
              <div class="theme-search-area theme-search-area-stacked">
                <div class="theme-search-area-form" style="margin-left: 40px;">
                  @include('resturants.UserChunks.SearchChunks')
                </div>
            ...
            <div class="tab-pane" id="SearchAreaTabs-3" role="tab-panel">
             <div class="theme-search-area theme-search-area-stacked">
              <div class="theme-search-area-form">
                <div class="row" data-gutter="none">
                 <form  action="{{url('searchome')}}" method="post" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data" style="color:black;">
      ...
      <div class="tab-pane" id="SearchAreaTabs-4" role="tab-panel">
        <div class="theme-search-area theme-search-area-stacked">
          <div class="theme-search-area-form">
           @include('Car.UserChunks.SearchChunks')
         </div>
            ...
            elseif($loop->iteration==2){ ?> 
              ...
              <?php  } else { ?>
                ...
                <div class="banner _h-33vh _br-3 banner-animate banner-animate-mask-in banner-animate-very-slow banner-animate-zoom-in">
                  <div class="banner-bg" style="background-image:url({{'destination/'.$des->des_folder.'/'.$des->des_pic}});"></div>
                  <form  action="{{ URL('destination_show') }}" id="formId{{$des->city_id}}" method="post" id="upload" enctype="multipart/form-data">
                    <div class="banner-mask"></div>

                    <a class="banner-link" onClick='submitDetailsForm({{$des->city_id}})'></a>


                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="city" value="{{$des->city_id }}">
                    <input type="hidden" name="des_session" value="{{$des->city_id }}">


                  </form>
                  <div class="banner-caption _pt-100 banner-caption-bottom banner-caption-grad">
                    <h5 class="banner-title">{{$des->city}}</h5>
                    <p class="banner-subtitle">{{$des->title}}</p>
                  </div>
                </div>
              </div>
