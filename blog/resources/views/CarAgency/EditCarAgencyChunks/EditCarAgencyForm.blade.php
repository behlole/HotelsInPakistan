@foreach($car_opr as $d)
<form enctype="multipart/form-data"  action="{{ URL('Car_Agency_Update',$agency_id) }}"  method="post" id="upload">
						...
						<div class="form-group">
							...
							<select class="itemName form-control" required=""  name="city"  data-error="#city_error">
								...
								if($d->city&&!old('city')){
									...
									?>
									<option value="{{$d->city}}">{{App\city_name::city_name_find($d->city)}}</option>
  ...
  <div class="col-md-6">
    ...
    box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);" id="blah" src="{{ URL::asset('caropr_image/'.$d->car_opr_folder.'/'.$d->uploadHeaderPhoto) }}" alt="your image" class="img-responsive center-block" />
				...
				<div class="row fmx" >
					<div class="col-md-6">
						<div class="form-group">
							...
							<input id="password" type="text" class="form-control" data-error="#contact_number"  name="contact" placeholder="Please Enter Contact Number" value="<?php 
					...
					<div class="col-md-6 ">
						<div class="form-group">
							...
							<input id="password" type="text" data-error="#contact_number_secondary" class="form-control" name="altcontact" placeholder="Secondary Contact if Any" value="<?php 
				...
				<div class="row fmx" >
					<div class="col-md-6">
						<div class="form-group">
							...
							<input id="password" type="text"   class="form-control" data-error="#landline_number" name="landline" placeholder="Please Enter Landline Number" value="<?php 
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input id="password" data-error="#home_email" type="email"  class="form-control" name="email" placeholder="Please Enter Agency Email" value="<?php 
				...
				<div class="row fmx" >
					<div class="col-md-6">
						<div class="form-group">
							...
							<input id="password" type="text" class="form-control" data-error="#website" name="website" placeholder="Please Enter Website URL" value="<?php 
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input id="password" type="text" class="form-control" data-error="#fb" name="facebookPage" placeholder="Please Enter Facebook Page Link" value="<?php 
  ...
  ?>"  class="form-control" readonly="" >
					...
					<input type="text" id="long" name="long" value="<?php 
  if($d->longitude&&!old('longitude')){
    echo($d->longitude);
  }
  else{
    echo old('longitude');
