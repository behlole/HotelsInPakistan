<div class="theme-payment-page-sections-item">
    <br><br>
    <h3 class="theme-payment-page-sections-item-title">Upload Gallery Images Of Your Cars</h3>
   <div class="theme-payment-page-form">
    <div class="row" data-gutter="20">
      <div class="col-md-12">
        <div class="form-group">
       <p style="color: red;" id="dropzone_error_txt"></p>
      <form  enctype="multipart/form-data" method="POST" action="{{url('add_cars_pictures_db/'.$car_id)}}" 
