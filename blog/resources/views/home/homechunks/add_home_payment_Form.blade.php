  <form  action="{{url('add_home_payemnts_db/'.$home_id)}}" method="post" class="form-submit labels-uppercase MultiFile-intercepted" id="Payment" enctype="multipart/form-data">
