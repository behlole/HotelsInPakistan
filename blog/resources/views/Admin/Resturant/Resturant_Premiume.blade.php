...
<section class="content">
	<form  action="{{url('Search_Restaurant_Premiume/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<select class="form-control" name="profile_check">
									...
									<option value="0">Premiume Restaurant</option>
								</select>
							</div>
							<div class="col-xs-1">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Restaurant Approved , Hide Restaurant , Restaurant Featured</h3>
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Perform_Restaurant_Premiume_By_City')}}" method="post" id="upload" enctype="multipart/form-data" style="margin:0px;padding: 0px; ">
								...
								<tr>
									...
									<td>
										{{$h->city}}
										@foreach(App\Models\Restaurant\restaurant_premiume::city_name($h->id) as $premiume)
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Premiume Hotel By City</h3>
						</div>
						<!-- /.box-header -->
