...
<section class="content">
	<form  action="{{url('search_Resturant_by_pending/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Resturant_Pending_Approval')}}" method="post" id="upload" enctype="multipart/form-data" style="margin:0px;padding: 0px; ">
								...
								<tr>
									...
									@foreach(App\Models\Restaurant\restaurant_type_name::selected_types_name($h->id) as $types_name )
										...
										<span class="badge bg-green">{{$types_name->restaurant_type_names}}</span>
									@endforeach
									</td>
