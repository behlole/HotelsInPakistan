...
<section class="content">
	<form  action="{{url('Search_Home_Premiume/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<select class="form-control" name="profile_check">
									...
									<option value="0">Premiume Home</option>
								</select>
							</div>
							<div class="col-xs-1">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Perform_Premiume_By_City_HOME')}}" method="post" id="upload"  style="margin:0px;padding: 0px;">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
								@foreach($data as $h)
								<tr>
