...
<section class="content">
	<form  action="{{url('Search_Car_Approved_or_Hide/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<select class="form-control" name="profile_check">
									<option value="1">Approved CarAgency</option>
									<option value="0">Hide CarAgency</option>
								</select>
							</div>
							<div class="col-xs-1">
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Perform_CarAgency_Featured_And_Hide')}}" method="post" id="upload" enctype="multipart/form-data" style="margin:0px;padding: 0px; ">
