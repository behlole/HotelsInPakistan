...
<section class="content">
	<form  action="{{url('Search_Hotel_Approved_or_Hide/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<select class="form-control" name="profile_check">
									<option value="1">Approved Hotel</option>
									<option value="0">Hide Hotel</option>
								</select>
							</div>
							<div class="col-xs-1">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Hotel Approved , Hide Hotel , Hotel Featured</h3>
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Perform_Hotel_Featured_And_Hide')}}" method="post" id="upload"  style="margin:0px;padding: 0px;">
								<input type="hidden" name="_token" value="{{ csrf_token() }}">
								@foreach($data as $h)
								<tr>
