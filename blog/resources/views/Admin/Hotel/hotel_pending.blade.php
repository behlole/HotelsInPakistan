...
<section class="content">
	<form  action="{{url('search_hotel_by_pending/')}}" method="get" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
		...
		<div class="col-xs-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Hotel Pending </h3>
				...
				<div class="box-body table-responsive no-padding">
					<table class="table table-bordered">
						<tbody>
							...
							<form  action="{{url('Perform_Hotel_Pending_Approval')}}" method="post" id="upload" enctype="multipart/form-data" style="margin:0px;padding: 0px; ">
