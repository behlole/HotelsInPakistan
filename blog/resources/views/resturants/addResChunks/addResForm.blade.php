<form  action="/add_res_listing_db" method="post" id="upload">
    ...
    <div class="row" data-gutter="20" id="errorTxt">
      ...
      <div class="col-md-12 ">
       <div class="form-group">
        ...
        <input id="password" type="text" data-error="#res_name" class="form-control" name="restaurant_name" placeholder="Restaurant Name" value="{{ old('restaurant_name') }}">
     ...
     <div class="col-md-6">
      <div class="form-group">
        ...
        <select class="form-control js-example-tags" id="sel1" name="restaurant_type[]" multiple="multiple">
          ...
          @foreach($restypes as $d)
          
            <option value="{{$d->id}}">{{$d->restaurant_type_names}}</option>
...
<div class="theme-payment-page-sections-item">
 ...
 <div class="theme-payment-page-form">
  ...
  <div class="form-group">
    ...
    <input id="password" type="text" class="form-control" name="contact"  data-error="#contact_number"  placeholder="Contact" value="{{ old('contact') }}">
...
<div class="col-md-6">
  <div class="form-group">
    ...
    <input id="password" type="text" class="form-control" data-error="#contact_number_secondary" name="alt_contact" placeholder="Alternate Contact" value="{{ old('alt_contact') }}">
...
<div class="col-md-6">
   <div class="form-group">
    ...
    <input id="password" type="text" class="form-control" name="landline" placeholder="Landline" value="{{ old('landline') }}">
...
<div class="col-md-6">
  <div class="form-group">
   ...
   <input id="password" type="text" class="form-control" name="restaurant_email" placeholder="Email" value="{{old('restaurant_email')}}">
...
<div class="col-md-6">
  <div class="form-group">
   ...
   <input id="password" type="text" class="form-control" data-error="#website" name="restaurant_website" placeholder="Please Enter Website URL" value="{{old('website')}}">
...
<div class="col-md-6">
   <div class="form-group">
     ...
     <input id="password" type="text" class="form-control" data-error="#fb" name="fb_page" placeholder="Facebook Page" value="{{old('fb_page')}}">
