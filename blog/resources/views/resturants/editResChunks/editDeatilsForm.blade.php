<form  action="{{ URL('add_restaurant_details_db',$restaurant_id) }}" method="post" class="form-submit labels-uppercase MultiFile-intercepted" id="upload" enctype="multipart/form-data">
  <br><br>
  @if (session('success'))
  ...
  <input type="hidden" name="form_check" value="edit">
   ...
   <h3 class="theme-payment-page-sections-item-title">Tell Us More About The {{$d->restaurant_name}}</h3>
