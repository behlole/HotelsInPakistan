    ...
    <div class="container">
     ...
     <div class="theme-item-page-header-price">
                <p class="theme-item-page-header-price-body">
                  <span>from</span>
                  <b>PKR {{App\car_opr::price_find($d->id)}}</b><br>
                  <span>Per Day</span>
                </p>
  ...
  <input type="hidden" name="agency_id" value="{{$d->caropr_id}}">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="btn btn-primary-inverse btn-block" href="{{ URL('booking_cars',$c->id) }}">Book now</a>
      ...
      <div class="col-md-3 ">
        <div class="sticky-col">
               ...
               @foreach(App\resad::ads_image_find('single','cars') as $img) 
