@include('useradmin.chunks.top')


{{-- @yield('userdash')--}}


{{-- @include('useradmin.chunks.bottom')--}}
                    ...
                    <div class="col-md-3">
                        <div class="sidebar-user">
                            ...
                            <div class="sidebar-menu">
                                {{-- <ul class="main-menu">
                                 <li class="">
                                     <a href="https://bookingcore.orgbooking-history">
                                         <span class="icon text-center"><i class="fa fa-clock-o"></i></span> Booking History
                                     </a>
                                 </li>
                                 <li class="">
                                     <a href="https://bookingcore.orgwishlist">
                                         <span class="icon text-center"><i class="fa fa-heart-o"></i></span> Wishlist
                                     </a>
                                 </li>
                                 <li class="">
                                     <a href="https://bookingcore.orgverification">
                                         <span class="icon text-center"><i class="fa fa-handshake-o"></i></span> Verifications
                                     </a>
                                 </li>
                                 <li class="active">
                                     <a href="profile.html">
                                         <span class="icon text-center"><i class="fa fa-cogs"></i></span> My Profile
                                     </a>
                                 </li>
                                 <li class="">
                                     <a href="profile\change-password.html">
                                         <span class="icon text-center"><i class="fa fa-lock"></i></span> Change password
                                     </a>
                                 </li>
                             </ul> --}}
                                ...
                                <ul class="main-menu">
                                    ...
                                    <li class=" has-children">
                                        ...
                                        <i class="caret"></i>
                                        <ul class="children">
                                            <li class=""><a href="resturents">
                                                    All Resurents</a></li>
                                            <li class=""><a href="resturents/add">
                                                    Add Resturent</a></li>
                                            <li class=""><a href="resturents/booking_report">
                                                    Availability</a></li>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div id="cdn-browser" class="cdn-browser d-flex flex-column" v-cloak=""
                        ...
                        {{--                                <div class="count-selected">{{selected.length}} file
                        selected
                    </div>--}}
