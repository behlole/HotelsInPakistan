 ...
 <form  action="<?php echo e(url('search_all_restaurants')); ?>" method="post">
                      ...
                      <div class="col-md-4 ">
                        <div class="theme-search-area-section theme-search-area-section-curved theme-search-area-section-sm theme-search-area-section-bg-white theme-search-area-section-no-border theme-search-area-section-mr" style="margin-left: 2px;">
                          <div class="theme-search-area-section-inner" style="">
                            ...
                            " style="">
                            <option style="" value="All">All Type</option><?php $__currentLoopData = $restaurant_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typesforsearch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option style="" value="<?php echo e($typesforsearch->id); ?>"><?php echo e($typesforsearch->restaurant_type_names); ?></option>
